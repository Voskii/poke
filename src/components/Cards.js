        ...
        <div>
                ...
                ?   
                    <>
                        ...
                        <div>
                            ...
                            <MediaQuery minWidth={521} maxWidth={884}>
                            <div>  
                        <label>
                            <Switch
                                checked={checked}
            ...
            <div>
                ...
                <div className='menu-container' ref={menuRef}>
                    ...
                    <div className={`dropdown-menu-shrink ${open? 'active' : 'inactive'}`} >
                        <ul className="inv-list-shrink">
                            {open
                            ?
                            inventory.map((item, index) => <><li onClick={(e) => {popPoke(e)}} className='dropdownItem' key={index}>{item.name}</li></>)
                            :
            ...
            <div className="entire-carousel-card-container">
                {bankInv
                ?
                <div className={isDesktopOrLaptop? "bank tform" : "bank tform"}>
                    <img src={bankImg}  />
                    {bankInv
                    ?
